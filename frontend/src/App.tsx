...
function App() {
  ...
  if (loading){
    ...
    return <Box className='center-flex-row' style={{padding:"100px"}}>
      <Title order={1} style={{textAlign:"center"}}>Error launching Kurilka!</Title>
      <Space h="md" />
    ...
    return <Box className='center-flex-row' style={{padding:"100px"}}>
      <Title order={3} style={{textAlign:"center"}}>No password, no kurilka</Title>
      <Space h="xl" />
    ...
    return <Box className='center-flex-row' style={{padding:"100px"}}>
      <Title order={2} style={{textAlign:"center"}}>Welcome to Kurilka :D</Title>
      <Space h="xl" />
