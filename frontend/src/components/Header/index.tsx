  ...
  return <AppShell.Header className="firegex__header__header" {...props}>
        ...
        <Box style={{ display: "flex", justifyContent: "center", alignItems: "center"}} ml={5}>
          ...
          <Box display="flex" style={{ flexDirection: "column" }} visibleFrom='xs'>
            <Title order={2} >Kurilka</Title>
            <p style={{margin: 0, fontSize: "70%"}}>By PudgeFunClub</p>
          </Box>
        </Box>
        ...
        <MenuDropDownWithButton>
          ...
          <Menu.Item color="red" leftSection={<MdOutlineSettingsBackupRestore size={18} />} onClick={() => setResetFiregexModal(true)}>Reset Kurilka</Menu.Item>
        </MenuDropDownWithButton>
        <Space w="md" />
